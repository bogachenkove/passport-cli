...
namespace filesystem::storage {
    ...
    // -------------------------------------------------------------------
    // Генерация имени с использованием криптосервиса
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // Нормализация пути без генерации имени
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // Нормализация пути с автоматической генерацией имени для каталога
    // -------------------------------------------------------------------
