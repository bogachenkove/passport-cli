...
namespace domain::interfaces {
	...
	public:
		...
		[[nodiscard]] virtual security::SecureString prompt_input(const std::string& prompt) = 0;
		[[nodiscard]] virtual security::SecureString prompt_password(const std::string& prompt) = 0;
