...
namespace security::storage {
	...
	public:
		...
		void add_mnemonicphrase_record(domain::models::MnemonicPhraseRecord record) override;
		...
		bool remove_mnemonicphrase_record(std::size_t index) override;
		...
		[[nodiscard]] const std::vector<domain::models::MnemonicPhraseRecord>& mnemonicphrase_records() const noexcept override;
		...
		[[nodiscard]] std::size_t mnemonicphrase_record_count() const noexcept override;
	...
	private:
		...
		std::vector<domain::models::MnemonicPhraseRecord> mnemonicphrase_records_;
