...
void PassportDatabase::add_record(const PasswordRecord& record) {
	records_.push_back(record);
}

bool PassportDatabase::remove_record(std::size_t index) {
...
const std::vector<PasswordRecord>& PassportDatabase::records() const noexcept {
	return records_;
}
